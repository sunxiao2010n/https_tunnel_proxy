...
int main(int argc, char *argv[])
{
	...
	strcpy(client.mobile, "13683315540");
	YMESubmitOrder(&client);
	
	//查询token
	//
	
	//userid":10000000,"mobile":"13434731138","sendid":"D152283190111765934"
	strcpy(client.mobile, "13683315540");
	strcpy(client.sendid, "F152584534324329234");
	strcpy(client.reqid, "1525845343");
	YMEReqToken(&client);
